    ...
    <section id="pricing" className="py-20">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white">Simple, Straightforward Pricing</h2>
        </div>
        <div className="grid lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700 flex flex-col">
            ...
            <ul className="mt-8 space-y-4 text-gray-400">
              <li className="flex items-start"><CheckIcon className="text-[#10b981] mr-3 mt-1 flex-shrink-0" /> 5 Generations / month</li>
          ...
          <div className="bg-gray-800/50 p-8 rounded-xl border-2 border-[#4f46e5] flex flex-col relative overflow-hidden">
            ...
            <p className="mt-2 text-sm text-yellow-400 font-semibold">Limited Time Early Bird Offer!</p>
            <p className="mt-2 text-5xl font-extrabold text-white">$6
              <span className="text-lg font-medium text-gray-400">/month</span>
              <span className="text-2xl text-gray-500 line-through ml-2">$9</span>
            </p>
            <ul className="mt-8 space-y-4 text-gray-400">
              ...
              <li className="flex items-start"><CheckIcon className="text-[#10b981] mr-3 mt-1 flex-shrink-0" /> Early access to new features</li>
            </ul>
          </div>
        </div>
      </div>
